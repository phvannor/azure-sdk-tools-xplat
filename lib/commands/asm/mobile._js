  ...
  */
  ...
  mobile.getSharedScript = function (options, callback) {
    ...
    var channel = getMobileChannel(options)
      ...
      .path('repository')
      .path('service')
      .path(options.script.type)
      .path(options.script[options.script.type].name + '.js');
  ...
  mobile.setSharedScript = function (options, script, callback) {
    ...
    log.json('silly', options);
    log.json('silly', script);
  ...
  function parseScriptName(scriptname) {
    var result = null,
        match = scriptname.match(/^(table|scheduler|shared|api|extensions)\/([^\.]+)/);
  ...
  var getScriptHandlers = {
    ...
    extensions: mobile.getSharedScript
  };
  ...
  var setScriptHandlers = {
    ...
    extensions: mobile.setSharedScript
  };
  ...
  var deleteScriptHandlers = {
    ...
    extensions: mobile.deleteSharedScript,    
  };
